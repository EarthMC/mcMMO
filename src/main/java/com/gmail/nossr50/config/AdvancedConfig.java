...
public class AdvancedConfig extends ConfigLoaderConfigurable {
    ...
    /* MINING */
    public int getBlastMiningRankLevel(int rank) { return getIntValue("Skills.Mining.BlastMining.Rank_Levels.Rank_" + rank); }
    public double getBlastDamageDecrease(int rank) { return getDoubleValue("Skills.Mining.BlastMining.BlastDamageDecrease.Rank_" + rank); }
    public double getOreBonus(int rank) { return getDoubleValue("Skills.Mining.BlastMining.OreBonus.Rank_" + rank); }
    public double getDebrisReduction(int rank) { return getDoubleValue("Skills.Mining.BlastMining.DebrisReduction.Rank_" + rank); }
    public int getDropMultiplier(int rank) { return getIntValue("Skills.Mining.BlastMining.DropMultiplier.Rank_" + rank); }
    public double getBlastRadiusModifier(int rank) { return getDoubleValue("Skills.Mining.BlastMining.BlastRadiusModifier.Rank_" + rank); }
